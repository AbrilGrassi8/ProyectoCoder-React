...
const pages = ['Nike', 'Adidas', 'Jordan'];
        ...
        <AppBar position="static">
            <Container disableGutters maxWidth="xl">
                <Toolbar disableGutters>
                    ...
                    <img src="https://res.cloudinary.com/dn3csswh5/image/upload/v1677503876/sneaker_esukij.png" style={{ marginRight: "20px",width: "8%", objectfit: "cover" }} alt="logopag" />
                    <Typography
                    variant="h6"
                    noWrap
                    component="a"
